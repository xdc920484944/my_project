...
# except:
#     import xie_xls
from spider.qita import xie_xls
...
xx02=['办公室出租', '写字楼出租', '合肥办公室', '合肥写字楼', '瑶海区写字楼', '庐阳区写字楼', '包河区写字楼', '滨湖区写字楼', '蜀山区写字楼', '经开区写字楼', '政务区写字楼', '高新区写字楼']
xx02 = xx02[:1]
print(xx02)
xx01='''办公室出租
写字楼出租
...
for y02 in range(0,len(xx02)):
    ...
    for y01 in range(2):
        ...
        zhuan01=[]
        if y01==0:
            n02=bs01.select('a[class="c-showurl c-color-gray"]')
            n002=[x.text for x in n02]
            zhuan01=n002
